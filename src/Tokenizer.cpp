...
// https://stackoverflow.com/questions/14094621/change-all-accented-letters-to-normal-letters-in-c
    ...
    unsigned char simplifySingleChar(unsigned char c, bool changeToLowerCase) {
    ...
    void simplifyString(string *s, bool changeToLowerCase) {
...
// removes punctuation from string "text", using std::ispunct to check for punctuation characters.
